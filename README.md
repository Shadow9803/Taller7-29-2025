📘 TallerHashMap Programa Java para crear un diccionario interactivo usando HashMap y ArrayList, con un menú que permite agregar, mostrar, modificar, eliminar y salir.
